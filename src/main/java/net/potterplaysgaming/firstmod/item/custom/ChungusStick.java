package net.potterplaysgaming.firstmod.item.custom;
...
public class ChungusStick extends Item {
    public ChungusStick(Properties properties) {
        super(properties);
    }
    ...
    public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
        ...
        if (!world.isRemote) {
            ...
            rightClickCertainBlockState(clickedBlock, context, playerEntity);
    ...
    private void rightClickCertainBlockState(BlockState clickedBlock, ItemUseContext context,
